...
mixin _$MoviesState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<MovieModel> popularMovies,
        ...
        loadedMoviesList,
    required TResult Function(MovieModel movie, List<PersonModel> movieCredits,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<MovieModel> popularMovies,
            List<MovieModel> topRatedMovies, List<MovieModel> upcomingMovies)?
        loadedMoviesList,
    TResult? Function(MovieModel movie, List<PersonModel> movieCredits,
            List<MovieModel> relatedMovies)?
        loadedMovieDetails,
  }) =>
      throw _privateConstructorUsedError;
...
class _$LoadedMovieDetailsImpl implements _LoadedMovieDetails {
  const _$LoadedMovieDetailsImpl(
      {required this.movie,
      required final List<PersonModel> movieCredits,
  ...
  final List<PersonModel> _movieCredits;
  @override
  List<PersonModel> get movieCredits {
    if (_movieCredits is EqualUnmodifiableListView) return _movieCredits;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_movieCredits);
  }
  ...
  @override
  String toString() {
    return 'MoviesState.loadedMovieDetails(movie: $movie, movieCredits: $movieCredits, relatedMovies: $relatedMovies)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._movieCredits, _movieCredits) &&
            const DeepCollectionEquality()
  ...
  TResult when<TResult extends Object?>({
    ...
    return loadedMovieDetails(movie, movieCredits, relatedMovies);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loadedMovieDetails?.call(movie, movieCredits, relatedMovies);
  }
